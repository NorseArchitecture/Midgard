...
static class ReferenceAssemblies
{
	...
	{
		var runtimeDirectory = Path.GetDirectoryName(typeof(object).Assembly.Location)!; // .../shared/Microsoft.NETCore.App/{version}
		...
		return Path.Combine(dotnetRoot, "packs", "Microsoft.NETCore.App.Ref", runtimeVersion, "ref", tfm, "System.Xml.ReaderWriter.dll");
	}
