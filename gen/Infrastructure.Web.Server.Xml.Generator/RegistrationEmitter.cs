...
static class RegistrationEmitter
{
	...
	public static string EmitEnumRegistration(string rootNamespace, IReadOnlyList<ShapeModel> shapes)
	{
		...
		sb.AppendCSharp(
			...
			/// <summary>Generated by Norse.Infrastructure.Web.Server.Xml.Generator — one name/value table per enum type reachable from this compilation's facade controllers.</summary>
