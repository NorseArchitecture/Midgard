...
static class Diagnostics
{
	public static readonly DiagnosticDescriptor RawScalarInRequestClosure = new(
		...
		"Member '{0}' on '{1}' is a raw scalar in the request closure — request scalars wrap in Result<T> or Result<T>?", "Norse.Xml",
	...
	public static readonly DiagnosticDescriptor ResultInResponseClosure = new(
		...
		"Member '{0}' on '{1}' wraps Result<T> in the response closure — response scalars are never wrapped", "Norse.Xml",
		DiagnosticSeverity.Error, isEnabledByDefault: true);
	...
	public static readonly DiagnosticDescriptor SharedAcrossDirections = new(
		...
		"'{0}' is reachable from both the request closure and the response closure — you shared a type across the boundary", "Norse.Xml",
		DiagnosticSeverity.Error, isEnabledByDefault: true);
	...
	public static readonly DiagnosticDescriptor InvalidContractShape = new(
		...
		"'{0}' must be sealed, derive from object only, and be non-generic to be reachable from a Futhark contract", "Norse.Xml",
		DiagnosticSeverity.Error, isEnabledByDefault: true);
