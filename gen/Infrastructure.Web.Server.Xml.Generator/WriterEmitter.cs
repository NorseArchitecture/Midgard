...
static class WriterEmitter
{
	...
	public static string Emit(string rootNamespace, ShapeModel shape)
	{
		...
		sb.AppendCSharp(
			...
			/// <summary>Generated by Norse.Infrastructure.Web.Server.Xml.Generator — canonical Futhark XML writer for <see cref="{{shape.TypeName}}"/>. Reader emission lands in a later generator task.</summary>
			...
			{{childWrites}}
				...
				public {{shape.TypeName}}? Read(global::System.Xml.XmlReader reader, {{XmlNs}}.XmlCaseStyle style, {{XmlNs}}.XmlReadContext context) =>
					throw new global::System.NotSupportedException("Futhark reader emission lands in a later generator task.");
	...
	static EnumTable GetOrAddEnumTable(MemberModel member, Dictionary<string, EnumTable> enumTables)
	{
	...
	static string NamesLiteral(EquatableArray<string> names)
	{
		List<string> quoted = [];
	...
	sealed record EnumTable(string SafeName, string EnumTypeName, List<EnumValueModel> Values, bool IsFlags);
}
