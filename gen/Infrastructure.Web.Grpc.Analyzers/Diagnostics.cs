...
static class Diagnostics
{
	...
	public static readonly DiagnosticDescriptor WireModelMutatedOutsideGuard = new(
		...
		"'{0}' mutates a shared RuntimeTypeModel directly — registration must go through WireModelRegistrationGuard.EnsureRegistered, the only call site proven safe under concurrent first touch",
		Category,
