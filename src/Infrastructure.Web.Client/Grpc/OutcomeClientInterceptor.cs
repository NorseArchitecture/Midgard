...
public sealed class OutcomeClientInterceptor : Interceptor
{
	...
	/// </summary>
	[SuppressMessage("Reliability", "CA2000:Dispose objects before losing scope", Justification = "The returned AsyncUnaryCall's Dispose delegate is call.Dispose — ownership transfers to the caller, exactly as it would for the unwrapped call the analyzer doesn't flag.")]
