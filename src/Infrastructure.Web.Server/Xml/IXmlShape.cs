...
public interface IXmlShape
{
	...
	/// <summary>Reads XML into a boxed instance of <see cref="ContractType"/>, accumulating failures into <paramref name="context"/> rather than throwing.</summary>
...
public interface IXmlShape<T> : IXmlShape
{
	...
	/// <summary>Reads XML into a <typeparamref name="T"/>, accumulating failures into <paramref name="context"/> rather than throwing.</summary>
