...
/// <param name="typeName">
///     The type name surfaced in <see cref="Norse.Primitives.Failure.ExpectedType" /> and
///     undefined-value throw messages.
/// </param>
...
public sealed class EnumNameTable(Type enumType, string typeName, string[][] names, long[] values)
{
	...
	/// <summary>
	///     The type name surfaced in <see cref="Norse.Primitives.Failure.ExpectedType" /> and undefined-value throw
	///     messages.
	/// </summary>
