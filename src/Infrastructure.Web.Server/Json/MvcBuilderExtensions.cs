...
public static class MvcBuilderExtensions
{
	extension(IMvcBuilder builder)
	{
		...
		/// </summary>
		/// <param name="registry">The generated per-enum name-table registry — the host passes <c>NorseEnumNameRegistration.Build()</c> (a later task's generator emission).</param>
