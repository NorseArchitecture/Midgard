...
- **NORSE029 is deleted, not narrowed** — a `[Flags]` member on a facade contract is law now. The tombstone stays in `Diagnostics.cs`; never renumber the surviving NORSE022–028.
